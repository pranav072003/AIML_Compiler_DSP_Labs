...
sigma_x = math.sqrt((np.mean(diabetes_x_train**2) - np.mean(diabetes_x_train)**2)) #sd for a sample 
sigma_y = math.sqrt((np.mean(diabetes_y_train**2) - np.mean(diabetes_y_train)**2)) #sd for a sample
