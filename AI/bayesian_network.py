...
class BayesianNetwork:
    ...
    def calculate_probability(self, node_name, node_value, evidence):
        ...
        E = parent_node.get_probability(parent_of_parent_values)
        A1 = node.get_probability([node_value])
        A2 = 1 - A1
        Epr = 1 - E
        probability = (E*A1)/(E*A1 + Epr*A2)
        return probability
...
probability = network.calculate_probability('JohnCalls', True, evidence)
